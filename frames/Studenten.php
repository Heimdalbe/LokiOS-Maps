...
<head>
    ...
    <meta property="og:title" content="LokiMaps - Wij hebben het studentenlokaal <?php echo $naam;?> gevonden!">
    <?php
...
?>
    <meta name="twitter:title" content="LokiMaps - Wij hebben het studentenlokaal <?php echo $naam;?> gevonden!">
    <meta name="twitter:description" content="LokiMaps - Wij hebben het studentenlokaal <?php echo $naam;?> gevonden!">
    <meta name="twitter:card" content="summary_large_image">
    <title>LokiMaps - Wij hebben de het studentenlokaal <?php echo $naam;?> gevonden!</title>
    <style>
        #map {
            height: 100%;
        }
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <h2 class="display-4">Wij hebben jouw het studentenlokaal gevonden!</h2>


                        <p>Jouw het studentenlokaal bevind zich op <b>'<?php echo $adress;?>'</b>. Indien jij deze campus niet weet zijn klik <a href="<?php echo $start;?>">hier</a>.</p>
                        <p>
                            <?php echo $route;?>
                        </p>
                        <hr>
