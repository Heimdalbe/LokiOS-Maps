...
?>
    ...
    <title>LokiMaps - Wij hebben het Leslokaal <?php echo $naam;?> gevonden!</title>
    <style>
        #map {
            height: 100%;
        }
    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <h2 class="display-4">Wij hebben jouw leslokaal gevonden!</h2>
                        <p>Jouw leslokaal bevind zich op <b>'<?php echo $adress;?>'</b>. Indien jij deze campus niet weet zijn klik <a href="<?php echo $start;?>">hier</a>.</p>
                        <p>
                            <?php echo $route;?>
                        </p>
                        <hr>
